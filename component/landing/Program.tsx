...
const ProgramSection = () => {
  return (
    <section
      id="program"
      className=" py-24 px-6 md:px-12 lg:px-24 bg-[#0B061D] text-white"
    >
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16">
        ...
        <div className="relative rounded-3xl p-10 md:p-14 bg-linear-to-br from-[#3A0057]/40 to-[#15002B]/60 border border-white/10 backdrop-blur">
          ...
          <p className="mt-4 text-soft-lavender text-base md:text-lg leading-relaxed">
            Synapse Studio packages mission design, credential minting, and
            analytics so you can focus on guiding learners while SYN keeps
            incentives aligned.
          </p>
        ...
        <div className="flex flex-col gap-6">
          {featuresRight.map((item, i) => (
            ...
            >
              ...
              <p className="text-soft-lavender text-sm leading-relaxed">
                {item.text}
              </p>
            </div>
          ))}
