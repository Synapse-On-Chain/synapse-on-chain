...
const CTASection = ({ onRequestAccess, onLogin }: CTASectionProps) => {
  return (
    <section
      id="cta"
      className="relative w-full py-32 bg-[#120024] overflow-hidden"
    >
      <div className="max-w-4xl mx-auto px-6 text-center text-white">
        ...
        <p className="mt-6 text-soft-lavender text-base leading-relaxed max-w-2xl mx-auto">
          Join the Synapse On Chain beta for access to launch quests, analytics,
          and premium classrooms tailored to your learners.
        </p>
